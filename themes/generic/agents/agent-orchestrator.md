...
|-------|------|-----------------|
| data-specialist | Data & Knowledge | Data extraction, enrichment, entity resolution, data quality |
| backend-engineer | Backend & Architecture | API design, database, system architecture, performance |
| data-processor | Data Processing | Pipelines, transformations, batch processing, ETL |
| technical-writer | Documentation & Research | Docs, research, literature review, planning artifacts |
| frontend-engineer | Frontend & UI | React, dashboards, visualization, CSS, accessibility |
| devops-engineer | Infrastructure & Security | DevOps, CI/CD, security review, performance optimization |
| qa-engineer | QA & Testing | Test suites, regression, benchmarks, edge cases |
| researcher | Research & Intelligence | Competitive research, web search, market analysis |
| auditor | Audit & Review | Code review, compliance, data quality audits |
| reporter | Reporting & Admin | Reports, summaries, metrics, data exports |
| tooling-engineer | Tooling & Internals | Dev tooling, hooks, plugins, platform internals |
...
| Pattern | Dispatch | Example |
|---------|----------|---------|
| One domain, one output | Solo | "Write tests" -> qa-engineer |
| Independent domains, same topic | Solo parallel | "Analyze 4 areas" -> 4 agents |
| Domain A builds, domain B validates | **Team** | data-processor extracts + data-specialist validates |
| Domain A implements, domain B tests | **Team** | Any agent codes + qa-engineer tests iteratively |
| Research informs documentation | **Team** | researcher investigates + technical-writer writes epic |
